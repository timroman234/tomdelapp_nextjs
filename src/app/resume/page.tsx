...
export default function ResumePage() {
  const { banner, lede, sections, closingParagraph, ctas, signOff, subscribeBand } = resumeContent;
  ...
  return (
    <>
      ...
      <section className="bg-cream">
        <div className="container-cr py-[66px] pb-10">
          <p className="mb-[22px] max-w-[66ch] font-heading text-[21px] leading-[1.5] text-ink-soft text-pretty">
            {lede}
          </p>
